#ifndef Parallel_quick_sort_2_h_
#define Parallel_quick_sort_2_h_

#include "thread_safe_stack.h"
// 没有合适的 thread_safe_stack，跑不通，可以借鉴一下思想
// template <typename T>
// struct sorter {
...
//         return result;
//     }
//     void sort_chunk(boost::shared_ptr<chunk_to_sort> const& chunk) { chunk->promise.set_value(do_sort(chunk->data)); }
//     void sort_thread() {
//         while (!end_of_data) {
//             try_sort_chunk();
...
// };
// template <typename T>
// std::list<T> parallel_quick_sort_2(std::list<T> input) {
//     if (input.empty()) {
//         return input;
//     }
//     sorter<T> s;
